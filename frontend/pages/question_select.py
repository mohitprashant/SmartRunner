    ...
    def set_components(self, screen):
        ...
        if self.input_data["custom_quiz_selection"] != "New Quiz":
            ...
            quiz_name_img = ImageDisplay("quiz_name_img", screen, quiz_name_img_rel_x, quiz_name_img_rel_y,
                                         quiz_name_img_rel_width, quiz_name_img_rel_height, quiz_name_back_img)
            ...
            quiz_name_image_box = TextDisplay("quiz_name_image_box", screen, quiz_name_image_rel_x,
                                              quiz_name_image_rel_y, quiz_name_image_rel_width,
                                              quiz_name_image_rel_height, quiz_name_image_img)
            ...
            new_quiz_name_img = ImageDisplay("new_quiz_name_image_box", screen, new_quiz_name_img_rel_x,
                                             new_quiz_name_img_rel_y, new_quiz_name_img_rel_width,
        ...
        custom_questions = SelectableTextList("custom_questions", screen, relative_x, relative_y, relative_width,
        ...
        return_button2 = ImageButton("return_button2", screen, return_button2_x, return_button2_y,
                                     return_button2_width, return_button2_height, return_button2__img)
        ...
        add_question_button2 = ImageButton("add_question_button2", screen, add_question_button2_x,
                                           add_question_button2_y, add_question_button2_width,
        ...
        delete_question_button2 = ImageButton("delete_question_button2", screen, delete_question_button2_x,
                                              delete_question_button2_y, delete_question_button2_width,
    ...
    def page_function(self, triggered_component_list):
        for triggered_component in triggered_component_list:
            ...
            if triggered_component in [self.components["delete_question_button2"]]:
                QuestionManager.delete_custom_question(self.output_data["username"],
                                                       self.output_data["roomID"],
