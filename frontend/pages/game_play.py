...
class Game(Page):
    ...
    def set_components(self, screen):
        ...
        if (self.multiplayer == False
                or ((self.is_client and self.input_data["ready_status"])
                    or (self.is_client == False and self.input_data["join_host"]))):
        ...
        if (self.multiplayer == False
            ...
            answer_text1 = TextDisplay("answer_text1", screen, relative_x, relative_y, relative_width,
                                       relative_height, self.answers[0][0])
            ...
            relative_width = 1/5
            relative_height = 1/15
            answer_text2 = TextDisplay("answer_text2", screen, relative_x, relative_y, relative_width,
                                       relative_height, self.answers[0][1])
            ...
            relative_width = 1/5
            relative_height = 1/15
            answer_text3 = TextDisplay("answer_text3", screen, relative_x, relative_y, relative_width,
                                       relative_height, self.answers[0][2])
            ...
            relative_width = 1/5
            relative_height = 1/15
            answer_text4 = TextDisplay("answer_text4", screen, relative_x, relative_y, relative_width,
                                       relative_height, self.answers[0][3])
            ...
            relative_width = 4/5
            relative_height = 1/15
            question_text = TextDisplay("question_text", screen, relative_x, relative_y, relative_width,
                                        relative_height, self.questions[0])
            ...
            relative_width = 4/5
            relative_height = 1/15
            host = TextDisplay("host", screen, relative_x, relative_y, relative_width,
                               relative_height, 'Thank you for hosting')
            ...
            relative_width = 4/5
            relative_height = 1/15
            client = TextDisplay("client", screen, relative_x, relative_y, relative_width,
                                 relative_height, 'Please wait for the game to end')
        ...
        progress = ImageDisplay("progress", screen, game_image_rel_x, game_image_rel_y, game_image_rel_width,
                                game_image_rel_height, progress)
    ...
    def questionupdate(self, screen, correct):
        ...
        if correct:
            ...
            relative_width = 1/5
            relative_height = 1/15
            correction = TextDisplay("correction", screen, relative_x, relative_y, relative_width,
                                     relative_height, 'Correct Answer')
            self.components["correction"] = correction
        else:
            relative_x = 5/20
            relative_y = 0.47
            ...
            relative_height = 1/15
            correction = TextDisplay("correction", screen, relative_x, relative_y, relative_width, relative_height,
                                     'The correct answer was : '+str(self.correct[self.questionstate-1]))
            self.components["correction"] = correction
        ...
        if self.questionstate >= len(self.questions):
            ...
            relative_height = 1 / 15
            question_text = TextDisplay("question_text", screen, relative_x, relative_y, relative_width,
                                        relative_height, 'No more questions')
            self.components["question_text"] = question_text
            return
        ...
        relative_height = 1 / 15
        question_text = TextDisplay("question_text", screen, relative_x, relative_y, relative_width,
                                    relative_height, self.questions[self.questionstate])
        self.components["question_text"] = question_text
        ...
        relative_height = 1 / 15
        answer_text1 = TextDisplay("answer_text1", screen, relative_x, relative_y, relative_width,
                                   relative_height, self.answers[self.questionstate][0])
        self.components["answer_text1"] = answer_text1
        ...
        relative_height = 1 / 15
        answer_text2 = TextDisplay("answer_text2", screen, relative_x, relative_y, relative_width,
                                   relative_height, self.answers[self.questionstate][1])
        self.components["answer_text2"] = answer_text2
        ...
        relative_height = 1 / 15
        answer_text3 = TextDisplay("answer_text3", screen, relative_x, relative_y, relative_width,
                                   relative_height, self.answers[self.questionstate][2])
        self.components["answer_text3"] = answer_text3
        ...
        relative_height = 1 / 15
        answer_text4 = TextDisplay("answer_text4", screen, relative_x, relative_y, relative_width,
                                   relative_height, self.answers[self.questionstate][3])
        self.components["answer_text4"] = answer_text4
    ...
    def display_score(self, screen):
        ...
        exit_btn = ImageDisplay("exit_btn", screen, game_image_rel_x, game_image_rel_y, game_image_rel_width,
                                game_image_rel_height, exit_btn)
