    ...
    def page_function(self, triggered_component_list):
        for triggered_component in triggered_component_list:
            ...
            if triggered_component in [self.components["create_acc_button"]]:
                ...
                #need to verify against database
                # if self.input_data["username"] == "username" and self.input_data["password"] == "password":
                #     return self.input_data
            # if triggered_component in ["create_acc_button", "username_input_box", "password_input_box"]:
            #     self.input_data["username"] = self.components["username_input_box"].input
            #     self.input_data["password"] = self.components["password_input_box"].input
            #
            # else:
            #     print("login failed")
