...
class HoseSettingsPage(Page):
    ...
    def set_components(self, screen):
        ...
        JoinAsHost_toggle = ImageButton("JoinAsHost_toggle", screen, JoinAsHost_toggle_x, JoinAsHost_toggle_y,
                                         JoinAsHost_toggle_width,
                                         JoinAsHost_toggle_height, JoinAsHost_toggle_img)
        ...
        # global qns button
        global_question_button_x = 1 / 20
        global_question_button_y = 7 / 16
        global_question_button_width = 1 / 2
        global_question_button_height = 1 / 8
        global_question_button_img = pygame.image.load('assets/img/save_btn.png')
        global_question_button = ImageButton("global_question_button", screen, global_question_button_x, global_question_button_y,
                                       global_question_button_width,
                                       global_question_button_height, global_question_button_img)
        ...
        custom_quiz_dropdown_x = 1 / 20
        custom_quiz_dropdown_y = 5 / 8
        custom_quiz_dropdown_width = 1 / 2
        custom_quiz_dropdown_height = 1 / 8
        custom_quiz_dropdown_img = pygame.image.load('assets/img/load_btn.png')
        custom_quiz_dropdown_button = ImageButton("custom_quiz_dropdown_button", screen, custom_quiz_dropdown_x,
                                                 custom_quiz_dropdown_y,
                                                 custom_quiz_dropdown_width,
                                                 custom_quiz_dropdown_height, custom_quiz_dropdown_img)
        self.components["custom_quiz_dropdown_button"] = custom_quiz_dropdown_button
        ...
        #dropdown values need to be registered to extract the right questions from database
        #custom quiz dropdown should have an option saying "Add custom quiz" that displays the "go" button
    def page_function(self, triggered_component_list):
        for triggered_component in triggered_component_list:
            if triggered_component in ["global_question_button", "return_button", "confirm_button"]:
                return self.data
            else:
                print("entry failed")
