...
class HostSettingsPage(Page):
    ...
    def set_components(self, screen):
        ...
        host_settings_image = ImageDisplay("host_settings_image", screen, host_settings_image_rel_x,
                                           host_settings_image_rel_y, host_settings_image_rel_width,
        ...
        JoinAsHost_display = ImageDisplay("JoinAsHost_display", screen, JoinAsHost_display_x, JoinAsHost_display_y,
                                          JoinAsHost_display_width, JoinAsHost_display_height, JoinAsHost_text)
        ...
        mode_toggle = ToggleButton("mode_toggle", screen, mode_toggle_rel_x, mode_toggle_rel_y, mode_toggle_rel_width,
                                   mode_toggle_rel_height, mode_toggle_image,
                                   mode_toggle_image2, self.input_data["mode_toggle"])
        ...
        Mode_display = ImageDisplay("Mode_display", screen, Mode_display_x, Mode_display_y, Mode_display_width,
        ...
        if self.input_data["mode_toggle"]:
            ...
            custom_quiz_image = ImageDisplay("custom_quiz_image", screen, custom_quiz_image_rel_x,
                                             custom_quiz_image_rel_y, custom_quiz_image_rel_width,
            ...
            custom_quiz_button = TextButton("custom_quiz_button", screen, custom_quiz_button_x, custom_quiz_button_y,
                                            custom_quiz_button_width, custom_quiz_button_height, custom_quiz_text)
