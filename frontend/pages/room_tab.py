...
class RoomTabPage(Page):
    ...
    def set_components(self, screen):
        ...
        create_room_button_y = 2 / 3
        create_room_button_width = 1 / 4
        create_room_button_height = 1 / 5
        create_room_button_img = pygame.image.load('assets/img/start_btn.png')
        ...
        manage_room_button_y = 2 / 3
        manage_room_button_width = 1 / 4
        manage_room_button_height = 1 / 5
        manage_room_button__img = pygame.image.load('assets/img/restart_btn.png')
