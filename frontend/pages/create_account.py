...
class CreateAccountPage(Page):
    ...
    def set_components(self, screen):
        ...
        cfmpassword_image_box = ImageDisplay("cfmpassword_image_box", screen, cfmpassword_image_rel_x,
                                             cfmpassword_image_rel_y, cfmpassword_image_rel_width,
                                             cfmpassword_image_rel_height, cfmpassword_image_img)
        ...
        create_acc_button = ImageButton("create_acc_button", screen, create_acc_button_rel_x,
                                        create_acc_button_rel_y, create_acc_button_rel_width,
        ...
        if self.output_data["error_check"]:
    ...
    def page_function(self, triggered_component_list):
        for triggered_component in triggered_component_list:
            ...
            if triggered_component in [self.components["create_acc_button"]]:
                ...
                create_acc_check = AccountManager.create_account_confirm_password(self.output_data["username"],
                                                                                  self.output_data["password"],
                                                                                  self.output_data["password1"])
                if create_acc_check is not None:
                    self.name = "login"
                else:
